...
import { Detailscard, DetailscardCharacter } from "./component/DetailscardCharacter.jsx"
			...
			<BrowserRouter basename={basename}>
				{/* <ScrollToTop> */}
					...
					<Routes>
						...
						<Route path="/characters/:idCharacter" element={<DetailscardCharacter />} />
						<Route path="/characters" element={<Characters />} />
						<Route path="/planets" element={<Planets />} />
						<Route path="/planets/:idPlanet" element={<DetailscardPlanet />} />
						<Route path="/starships" element={<Starships />} />
						<Route path="/starships/:idStarship" element={<DetailscardStarship />} />
					</Routes>
					<Footer />
				{/* </ScrollToTop> */}
			</BrowserRouter>
